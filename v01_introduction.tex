...
\begin{frame}
 ...
 \begin{enumerate}
  ...
  \item Frequenzanalyse % FFT, Superpositionsprinzip
  \item Mechanisches Bodenverhalten % unter zyklischer Belastung
  \end{enumerate}
  \item Wellenausbreitung im Untergrund
  \begin{enumerate}
  \item Dehnstabsmodell (1D)
  \item Elastodynamik (3D) %(Koerper- und Oberflächenwellen)
  \end{enumerate}
  \item Praktische Anwendung
  \begin{enumerate}
  \item Kennwertermittlung % Schwingungsmesstechnik, Labor- und Feldmessungen
  \item Konstruktionskriterien % Erschuetterungseinwirkungen und erdbebensicheres Bauen
  \end{enumerate}
  \item Ausblick
  \end{enumerate}
...
\frametitle{Organisatorisches}
    \begin{itemize}
        ...
        \begin{itemize}
         \item angelehnt an \textsl{\cite{Verruijt2010, Vrettos2017, Schmidt2017}} % TODO Studer2008
        \end{itemize}
