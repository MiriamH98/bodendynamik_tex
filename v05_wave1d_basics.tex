...
\hfill 
\input{fig_tikz/wave_left_right}
\begin{align*}
 \xi &= z+ct \\
 \eta &= z-ct 
\end{align*}
...
\only<1>{
\begin{center}
\input{fig_tikz/wave_influence_cone}
Einflussbereich
\end{center}
}
...
\only<2>{
\begin{center}
\input{fig_tikz/wave_dependency_cone}
...
\input{ani_tikz/wave_initiation}
\end{center}
}

\only<2>{
\begin{center}
\input{fig_tikz/wave_solution_z_t}
...
\input{fig_tikz/semiinf_wavebar}
\begin{align*}
 \Phi(z)&=\frac{1}{2}w_0(z)-\frac{1}{2c} \int_{z_0}^z  \dot{w}_0(\bar{z})\,\mathrm{d}\bar{z},\\
 \Psi(z)&=\frac{1}{2}w_0(z)+\frac{1}{2c} \int_{z_0}^z  \dot{w}_0(\bar{z})\,\mathrm{d}\bar{z},\\
\end{align*}
...
\begin{equation*}
 w(z,t)=\left\{ \begin{array}{ll}
  ...
  \right.
\end{equation*}
\input{fig_tikz/wave_reflection_z_t}
\end{frame}
...
\begin{center}
\vspace{-6cm}
\input{ani_tikz/wave_reflection_fixed}
\end{center}
}
...
\begin{center}
\vspace{-6cm}
\input{ani_tikz/wave_reflection_free}
\end{center}
}
...
\input{fig_tikz/wavebar_transition}
...
\input{fig_tikz/wavebar_discrete_elements}
