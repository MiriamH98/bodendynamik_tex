...
\begin{frame}
 ...
 \input{fig_tex/tikz_wavebar_forces}
 \end{column}
        \begin{column}[t]{.5\linewidth}
        \vspace{-5cm}
        \begin{align*}
...
\hfill 
\input{fig_tex/tikz_wave_left_right}
\begin{align*}
 \xi &= z+ct \\
 \eta &= z-ct 
\end{align*}
...
\only<1>{
\begin{center}
\input{fig_tex/tikz_wave_influence_cone}
Einflussbereich
\end{center}
}
...
\only<2>{
\begin{center}
\input{fig_tex/tikz_wave_dependency_cone}
...
\input{fig_tex/animated_tikz_wave_initiation}
\end{center}
}

\only<2>{
\begin{center}
\input{fig_tex/tikz_wave_solution_z_t}
...
\input{fig_tex/tikz_semiinf_wavebar}
\begin{align*}
 \Phi(z)&=\frac{1}{2}w_0(z)-\frac{1}{2c} \int_{z_0}^z  \dot{w}_0(\bar{z})\,\mathrm{d}\bar{z},\\
 \Psi(z)&=\frac{1}{2}w_0(z)+\frac{1}{2c} \int_{z_0}^z  \dot{w}_0(\bar{z})\,\mathrm{d}\bar{z},\\
\end{align*}
...
\begin{equation*}
 w(z,t)=\left\{ \begin{array}{ll}
  ...
  \right.
\end{equation*}
\input{fig_tex/tikz_wave_reflection_z_t}
\end{frame}
...
\begin{center}
\vspace{-6cm}
\input{fig_tex/animated_tikz_wave_reflection_fixed}
\end{center}
}
...
\begin{center}
\vspace{-6cm}
\input{fig_tex/animated_tikz_wave_reflection_free}
\end{center}
}
...
\input{fig_tex/tikz_wavebar_transition}
...
\begin{frame}
 \frametitle{Beispiel}
\begin{figure}
\includegraphics[width=0.475\textwidth]{fig_img/transition_z_v}
\hfill
\includegraphics[width=0.4\textwidth]{fig_img/transition_z_sigma}
...
\input{fig_tex/tikz_wavebar_discrete_elements}
