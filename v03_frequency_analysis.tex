...
\only<1>{
\begin{center}
\input{fig_tikz/multiharmonic_analysis}
...
\begin{columns}
        ...
        \only<1>{
\input{fig_tikz/discrete_ortho_base}
         }
         \only<2-3>{
\input{fig_tikz/discrete_some_base}         
         }
        \end{column}
		\hfill
...
\input{fig_tikz/continuous_some_base}
