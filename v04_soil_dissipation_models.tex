...
\input{fig_tex/tikz_complex_number}
         \begin{align*}
...
\hspace{1cm}
\input{fig_tex/tikz_complex_re_im}
\begin{align*}
...
\begin{columns}
        ...
        \input{fig_tex/tikz_energy_storage_t_F.tex}
\bigskip
        ...
        \input{fig_tex/tikz_energy_sink_t_F.tex}
        \bigskip
...
\begin{columns}
        \begin{column}[t]{.5\linewidth}
        \input{fig_tex/tikz_energy_general_t_F.tex}     
\bigskip
