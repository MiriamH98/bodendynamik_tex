...
\input{fig_tex/animated_tikz_1dof}
}

\only<2>{
\begin{figure}
\includegraphics[width=\textwidth]{fig_img/haus1dof} 
...
\begin{columns}
        ...
        \begin{figure}
\input{fig_tex/tikz_undamped_1dof_free}

\uncover<2-5>{
\input{fig_tex/tikz_undamped_1dof_free_forces}
}
...
\begin{columns}
        \begin{column}[t]{.5\linewidth}
        \begin{figure}
\input{fig_tex/tikz_damped_1dof_free}

\uncover<2-4>{
\input{fig_tex/tikz_damped_1dof_free_forces}
}
...
\input{fig_tex/tikz_damped_1dof_free_t_u}
...
\begin{columns}
        \begin{column}[t]{.5\linewidth}
        \begin{figure}
\input{fig_tex/tikz_undamped_1dof_forced}
\uncover<2-4>{
\input{fig_tex/tikz_undamped_1dof_forced_forces}
}
\caption*{Modell \uncover<2-4>{und Freischnitt}}
\end{figure}
        \end{column}
...
\uncover<2-4>{
\input{fig_tex/tikz_damped_1dof_forced_forces}
}
\caption*{Modell \uncover<2-4>{und Freischnitt}}
\end{figure}
        \end{column}
...
\only<1>{
\input{fig_tex/tikz_damped_1dof_forced_t_au}
}
