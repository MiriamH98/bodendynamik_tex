...
\only<2>{
\begin{figure}
\input{fig_tex/tikz_wave_beat_shift}
...
\vspace{-7cm}  
\begin{figure}
\hspace{5cm}\animategraphics[draft,loop,autoplay]{10}{fig_img/mikomma/impnorm-}{0}{49}
...
\input{fig_tex/tikz_wave_phase_velocity}
 \begin{equation*}
...
\input{fig_tex/tikz_wave_group_velocity}
\begin{equation*}
...
\begin{figure}
\input{fig_tex/tikz_wave_dispersion_relation}
...
\input{fig_tex/tikz_wavebar_friction}
\end{frame}
...
\begin{figure}
\includegraphics[width=0.65\textwidth]{fig_img/wavebar_friction}
...
\begin{figure}
\input{fig_tex/tikz_dispersion_example}
...
\input{fig_tex/tikz_earthquake1d_model}
...
\input{fig_tex/tikz_earthquake1d_bc}
\end{column}
...
\begin{figure}
\includegraphics[width=0.525\textwidth]{fig_img/earthquake_top_load.pdf}
